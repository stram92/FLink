...
import com.saladstudios.FLink.databinding.FragmentCookingBinding
...
class CookingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val cookingViewModel =
            ViewModelProvider(this).get(com.saladstudios.FLink.ui.cooking.CookingViewModel::class.java)
